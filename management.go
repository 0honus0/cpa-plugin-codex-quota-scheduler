...
<div class="warning" id="resetProbeWarning" hidden><strong data-i18n="resetProbe.warningTitle">自动 reset probe 默认关闭</strong><span data-i18n="resetProbe.warningBody">只有勾选后，调度器才会在 reset 看起来 lazy 时发送一个极小 Codex 请求来启动下一个额度窗口。</span></div>

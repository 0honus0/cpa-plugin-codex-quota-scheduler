...
var invariantExplicitOwners = map[string][]string{
	...
	"INV-02 negative": {"TestProductionProvisionalVerificationRejectsMismatchWithoutOpenAI", "TestAutonomousDegradedExpiryAtRequestBoundaries"},
	...
	"INV-21 negative": {"TestFailClosedHoldsAndRecoveryRecomputesProbe", "TestAutonomousDegradedExpiryAtRequestBoundaries"},
	...
	"INV-35 positive": {"TestProductionRosterLifecycleGatesBackgroundRequests", "TestAutonomousDegradedExpiryAtRequestBoundaries"},
	...
	"INV-43 negative": {"TestSchedulerPickPublishesWhileOlderHostCallIsBlocked", "TestProductionSchedulerPickActivityIsAsyncBoundedAndWakesDormantRefresh"},
